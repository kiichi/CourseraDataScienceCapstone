...
I would use the list of profanity words from [Front Game Media's Blog Article](http://www.frontgatemedia.com/a-list-of-723-bad-words-to-blacklist-and-how-to-use-facebooks-moderation-tool/). The profainity file has to be cleaned too because contains website information and comma within the cell. The code below extract the list as character vector.
